class Rnastructviz < Formula
  ...
  url "https://github.com/gtDMMB/RNAStructViz/archive/v1.5.5-testing.tar.gz"
  sha256 "326f38ca2aeda2ad22eea31215455547cf3320bb39ba02c717310a61bf79cd61"
  version "v1.5.5-testing"
  revision 1
